...
- **Definição de sucesso:** Redução estatisticamente significativa na
  média da pontuação total do PHQ-9 no grupo de intervenção (MindMove)
...
1.  **Redução dos níveis de ansiedade:** Avaliada através da escala
    *Generalized Anxiety Disorder-7* (GAD-7) nas semanas 0, 4 e 8,
    permitindo aferir a co-ocorrência de melhorias nos sintomas
    ansiosos.

2.  **Melhoria na qualidade do sono:** Medida através do *Pittsburgh
    Sleep Quality Index* (PSQI) às 8 semanas, para verificar se os
    módulos de higiene do sono da *app* resultam em benefícios
    clinicamente observáveis.

3.  **Aumento dos níveis de atividade física:** Quantificado em minutos
    de atividade física moderada a vigorosa por semana (através de
    autorrelato), para avaliar o impacto dos lembretes e incentivos da
    *app* no estilo de vida dos estudantes.

4.  **Nível de adesão e *engagement*:** Monitorizado através de métricas
    de utilização da *app* (ex: frequência de acesso semanal, tempo de
    uso diário e número de módulos de dCBT e técnicas de mindfulness
    completados) durante as 8 semanas.

5.  **Satisfação e aceitabilidade:** Avaliadas ao final das 8 semanas
    através de um questionário de satisfação (ex: *Client Satisfaction
...
Para a ansiedade (GAD-7) e qualidade do sono (PSQI), utilizaremos uma
